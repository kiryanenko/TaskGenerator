...
[1 Анализ требований и уточнение спецификаций](#анализ-требований-и-уточнение-спецификаций)

[1.1 Анализ задания и выбор технологии, языка и среды разработки](#анализ-задания-и-выбор-технологии-языка-и-среды-разработки)

[1.2 Разработка диаграммы вариантов использования](#разработка-диаграммы-вариантов-использования)

[1.3 Разработка концептуальной диаграммы классов](#разработка-концептуальной-диаграммы-классов)

[1.4 Анализ способа хранения информации и выбор системы хранения](#анализ-способа-хранения-информации-и-выбор-системы-хранения)

[2 Проектирование структуры и компонентов программного продукта](#проектирование-структуры-и-компонентов-программного-продукта)

[2.1 Разработка интерфейса пользователя](#разработка-интерфейса-пользователя)

[2.1.1 Построение графа (диаграммы) состояний интерфейса](#построение-графа-диаграммы-состояний-интерфейса)

[2.1.2 Разработка форм ввода-вывода информации](#_Toc468375036)

[2.1.2.1 Главная страница](#главная-страница)

[2.1.2.2 Страница регистрации](#страница-регистрации)

[2.1.2.3 Страница входа](#страница-входа)

[2.1.2.4 Страница помощи](#страница-помощи)

[2.1.2.5 Страница поиска](#страница-поиска)

[2.1.2.6 Страница добавления / редактирования задачи](#страница-добавления-редактирования-задачи)

[2.1.2.7 Элемент из списка задач](#элемент-из-списка-задач)

[2.1.2.8 Страница просмотра задачи](#страница-просмотра-задачи)

[2.1.2.9 Страница добавления / редактирования группы задач](#страница-добавления-редактирования-группы-задач)

[2.1.2.10 Элемент из списка группы задач](#элемент-из-списка-группы-задач)

[2.1.2.11 Страница группы задач](#страница-группы-задач)

[2.1.2.12 Страница добавления / редактирования билета](#страница-добавления-редактирования-билета)

[2.1.2.13 Элемент из списка билетов](#элемент-из-списка-билетов)

[2.1.2.14 Страница просмотра всех билетов (задач, групп задач) пользователя](#страница-просмотра-всех-билетов-задач-групп-задач-пользователя)

[2.1.2.15 Страница билета](#страница-билета)

[2.1.2.16 Страница просмотра сгенерированных вариантов](#страница-просмотра-сгенерированных-вариантов)

[2.2. Разработка структурной схемы программного продукта](#разработка-структурной-схемы-программного-продукта)

[2.3 Разработка схем алгоритмов модулей](#разработка-схем-алгоритмов-модулей)

[2.4 Разработка диаграммы размещения](#разработка-диаграммы-размещения)

[3. Выбор стратегии тестирования и разработка тестов](#выбор-стратегии-тестирования-и-разработка-тестов)

[3.1 Стратегии тестирования](#стратегии-тестирования)

[3.2 Черный ящик](#черный-ящик)

[3.3 Оценочное тестирование](#оценочное-тестирование)
